...
3.I study at BSU, Faculty of Radiophysics and Computer Technologies. My strengths are quick learning, communication and desire to learn.
...
float addition(list* li)// тут складываем наши ’
{
    list p;
...
int main()
{
    ...
    cin >> n;
    list* X = new list[n];
    for (int i = 0; i < n + 1; i++)// заполн€ем наши х дробными числами
    {
        int v;
        float x, c;
        c = rand() % 100;
